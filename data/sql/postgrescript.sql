...
CREATE TABLE usuario (
  ...
  nombre VARCHAR(45),
  apellido VARCHAR(45),
  rol VARCHAR(20) NOT NULL CHECK (rol IN ('administrador', 'comprador')),
...
CREATE TABLE comprador (
  ...
  id_estado INT REFERENCES estado (id_estado),
  id_municipio INT REFERENCES municipio (id_municipio),
  id_parroquia INT REFERENCES parroquia (id_parroquia),
  calle VARCHAR(100)
);
...
-- ==========================================
-- TABLAS DE MEMBRESIA Y SOLICITUDES
-- ==========================================
...
CREATE TABLE factura (
  ...
  id_obra VARCHAR(24) NOT NULL,
  id_comprador INT NOT NULL REFERENCES usuario (id_usuario),
  id_admin INT NOT NULL REFERENCES usuario (id_usuario),
  fecha_venta TIMESTAMP,
  monto_neto DECIMAL(20,2) NOT NULL,
  iva DECIMAL(20,2) NOT NULL,
  total_pagado DECIMAL(20,2) NOT NULL,
  ganancia_usd DECIMAL(20,2) NOT NULL,
  porcentaje_comision DECIMAL(5,2) NOT NULL
);

CREATE TABLE envio (
  id_envio SERIAL PRIMARY KEY,
  id_factura INT UNIQUE NOT NULL REFERENCES factura (id_factura),
  fecha_envio TIMESTAMP,
  monto_total DECIMAL(20,2),
  estado_entrega VARCHAR(20) CHECK (estado_entrega IN ('En proceso', 'Enviado', 'Entregado'))
);
...
-- ==========================================
-- DATOS GEOGRAFICOS DE VENEZUELA
-- ==========================================
...
-- ==========================================
INSERT INTO usuario (id_usuario, email, password, nombre, apellido, activo, rol) VALUES
(1, 'alejandro.briceno@email.com', 'Admin1234', 'Alejandro', 'Briceño', TRUE, 'administrador'),
(2, 'kelvys.concepcion@email.com', 'Admin1234', 'Kelvys', 'Concepcion', TRUE, 'administrador'),
(3, 'rolannys.sanchez@email.com', 'Admin1234', 'Rolannys', 'Sanchez', TRUE, 'administrador'),
(4, 'angel.laucho@email.com', 'Admin1234', 'Angel', 'Laucho', TRUE, 'administrador'),
(5, 'ivanna.bravo@email.com', 'Admin1234', 'Ivanna', 'Bravo', TRUE, 'administrador');

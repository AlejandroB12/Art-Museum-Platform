    ...
    return {
        ...
        <body style="margin:0; padding:0; background-color:#121212; font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;">
            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#121212; padding:40px 20px;">
                <tr><td align="center">
                    <table width="560" cellpadding="0" cellspacing="0" style="background:#1e1e1e; border:1px solid #18b2af; border-radius:12px; box-shadow:0 10px 40px rgba(24, 178, 175,0.1); max-width:100%;">
                        <tr><td style="padding:40px 35px; text-align:center;">
                            <div style="font-size:48px; margin-bottom:15px;">&#10003;</div>
                            <h1 style="color:#18b2af; font-size:28px; font-weight:800; text-transform:uppercase; letter-spacing:-1px; margin:0 0 8px;">¡Bienvenido!</h1>
                            <p style="color:#ffffff; font-size:18px; font-weight:600; margin:0 0 15px;">Tu registro ha sido aprobado</p>
                            <p style="color:#888; font-size:14px; line-height:1.7; margin:0 0 10px;">Hola <strong style="color:#18b2af;">${usuario.Nombre} ${usuario.Apellido}</strong>,</p>
                            ...
                            <div style="background:rgba(24, 178, 175,0.05); border-left:4px solid #18b2af; border-radius:6px; padding:20px; margin-bottom:25px;">
                                <p style="color:#999; font-size:12px; text-transform:uppercase; letter-spacing:1px; margin:0 0 8px;">Tu código de verificación</p>
                                <p style="color:#18b2af; font-size:32px; font-weight:900; letter-spacing:6px; margin:0; text-shadow:0 0 20px rgba(24, 178, 175,0.4);">${codigo}</p>
                            </div>
                            ...
                            <table cellpadding="0" cellspacing="0" align="center">
                                <tr><td align="center" style="background:#18b2af; border-radius:5px; padding:14px 40px;">

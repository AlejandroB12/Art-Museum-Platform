...
(async () => {
    ...
    try {
        ...
        const db = mysql.createConnection({host:process.env.DB_HOST,user:process.env.DB_USER,password:process.env.DB_PASSWORD_MYSQL,database:process.env.DB_NAME_MYSQL});
